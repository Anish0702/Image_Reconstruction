...
# SAVE IMAGES
# ========================
os.makedirs("Pictures\\Results\\Method 3\\results_dft_hybrid", exist_ok=True)

imsave("Pictures\\Results\\Method 3\\results_dft_hybrid/original.png", (img*255).astype(np.uint8))
imsave("Pictures\\Results\\Method 3\\results_dft_hybrid/sampled.png", (sparse*255).astype(np.uint8))
imsave("Pictures\\Results\\Method 3\\results_dft_hybrid/reconstructed.png", (recon*255).astype(np.uint8))
