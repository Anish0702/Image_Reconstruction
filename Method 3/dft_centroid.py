...
# SAMPLING
# ========================
def centroid_sampling(img, segments):
...
seg = segment(img)
mask = centroid_sampling(img, seg)
...
# SAVE IMAGES
# ========================
os.makedirs("Pictures\\Results\\Method 3\\results_dft_centroid", exist_ok=True)

imsave("Pictures\\Results\\Method 3\\results_dft_centroid/original.png", (img*255).astype(np.uint8))
imsave("Pictures\\Results\\Method 3\\results_dft_centroid/sampled.png", (sparse*255).astype(np.uint8))
imsave("Pictures\\Results\\Method 3\\results_dft_centroid/reconstructed.png", (recon*255).astype(np.uint8))
