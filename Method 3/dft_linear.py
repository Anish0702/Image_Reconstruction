...
# SAVE IMAGES
# ========================
os.makedirs("Pictures\\Results\\Method 3\\results_dft_linear", exist_ok=True)

imsave("Pictures\\Results\\Method 3\\results_dft_linear/original.png", (img*255).astype(np.uint8))
imsave("Pictures\\Results\\Method 3\\results_dft_linear/sampled.png", (sparse*255).astype(np.uint8))
imsave("Pictures\\Results\\Method 3\\results_dft_linear/reconstructed.png", (recon*255).astype(np.uint8))
